...
public final class MRoomAvatar extends koma.matrix.event.room_message.state.RoomStateEvent {
    ...
    @org.jetbrains.annotations.NotNull()
    private final koma.matrix.event.room_message.state.RoomAvatarContent content = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final koma.matrix.event.room_message.state.RoomAvatarContent getContent() {
        return null;
    }
    
    public MRoomAvatar(@org.jetbrains.annotations.NotNull()
