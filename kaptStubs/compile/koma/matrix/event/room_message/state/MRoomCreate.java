...
public final class MRoomCreate extends koma.matrix.event.room_message.state.RoomStateEvent {
    ...
    @org.jetbrains.annotations.NotNull()
    private final koma.matrix.event.room_message.state.RoomCreateContent content = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final koma.matrix.event.room_message.state.RoomCreateContent getContent() {
        return null;
    }
    
    public MRoomCreate(@org.jetbrains.annotations.NotNull()
    ...
    koma.matrix.event.room_message.state.RoomCreateContent content) {
    }
}