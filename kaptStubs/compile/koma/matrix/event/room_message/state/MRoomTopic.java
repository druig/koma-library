...
public final class MRoomTopic extends koma.matrix.event.room_message.state.RoomStateEvent {
    ...
    @org.jetbrains.annotations.NotNull()
    private final koma.matrix.event.room_message.state.RoomTopicContent content = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final koma.matrix.event.room_message.state.RoomTopicContent getContent() {
        return null;
    }
    
    public MRoomTopic(@org.jetbrains.annotations.NotNull()
    ...
    koma.matrix.event.room_message.state.RoomTopicContent content) {
    }
}