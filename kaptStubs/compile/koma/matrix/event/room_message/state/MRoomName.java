...
public final class MRoomName extends koma.matrix.event.room_message.state.RoomStateEvent {
    ...
    @org.jetbrains.annotations.NotNull()
    private final koma.matrix.event.room_message.state.RoomNameContent content = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final koma.matrix.event.room_message.state.RoomNameContent getContent() {
        return null;
    }
    
    public MRoomName(@org.jetbrains.annotations.NotNull()
    ...
    koma.matrix.event.room_message.state.RoomNameContent content) {
    }
}